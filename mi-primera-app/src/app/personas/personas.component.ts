...
@Component({
    ...
    /* Aquí puedo agregar una plantilla html cambiando la propiedad
    del decorador y podemos escribir directamente código html donde dice template  */
    ...
    `]/* si vamos a agregar una sola línea de estilos aplicamos comillas
    simples '' si es más de una línea lo hacemos con comillas simples
    invertidas `` y con ello ya podemos darle al botón enter dentro del arreglo */
})
export class PersonasComponent {
    ...
    tituloPersona = 'Ingeniero'; /* POr aquí es por dónde nos traemos
    la información que desamos capturar esto me sirve para el desarrollo de la aplicación de la empresa */
    ...
    constructor() {
        setTimeout(
            ...
            () => {
                /* y dentro de esta función flecha vamos a proceder a modificar
                nuestra propiedad agregarPersona y en lugar de que sea el valir false vamos a cambiarlo a true */
